---
title: "Country report for `r params$unit_results$uName`"
date: "`r Sys.Date()`"
output:
  html_document
...
`r iname` is ranked `r rnk` out of `r nrow(df_results)` in the overall index. At the pillar level, its scores are summarised as follows:
